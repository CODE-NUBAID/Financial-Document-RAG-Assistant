...
Demonstrates the 'structured output' pattern: instead of free-text RAG
answers, we ask the LLM to return strict JSON matching a known schema.
This is a common real-world AI engineering technique (function-calling /
JSON mode) for turning unstructured documents into structured records.
"""
